data{
  ...
  array[N_state_polls] int<lower=1, upper=Pop> poll_pop_state;       // Poll population index
  array[N_national_polls] int<lower=1, upper=Pop> poll_pop_national; // Poll population index
  ...
  array[N_national_polls] real<lower=0, upper=1> unadjusted_national;
  array[N_state_polls] real<lower=0, upper=1> unadjusted_state;
...
transformed parameters {
  ...
  logit_pi_democrat_national = 
    ...
    to_vector(unadjusted_national) .* e_bias[day_national] +
